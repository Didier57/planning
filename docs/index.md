...
- [Installation Guide](installation.md) — System requirements, setup wizard, Docker
- [Upgrade Guide](upgrade-guide.md) — Upgrading from previous versions
- [Migration Guide: v1.x to v2.0](migration-v2.md) — Breaking changes and migration steps
- [Configuration Reference](configuration.md) — All settings explained

## For Users

- [User Guide](user-guide.md) — Calendar views, events, preferences
- [Import & Export](import-export.md) — iCalendar and other formats
...
- [GitHub Issues](https://github.com/craigk5n/webcalendar/issues) — Bug reports and feature requests
- [GitHub Discussions](https://github.com/craigk5n/webcalendar/discussions) — Questions and community
